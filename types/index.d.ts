...
declare class Viewer {
  ...
  next(loop?: boolean): Promise<Viewer>;
  play(fullscreen?: boolean | FullscreenOptions): Viewer;
  prev(loop?: boolean): Promise<Viewer>;
  reset(): Viewer;
  ...
  show(immediate?: boolean): Promise<Viewer>;
  stop(): Viewer;
  toggle(): Viewer;
  tooltip(): Viewer;
  update(): Promise<Viewer>;
  init(): Promise<void>;
  view(index?: number): Promise<Viewer>;
